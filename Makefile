...
release:          ## Create a new tag for release.
	...
	@echo "$${TAG}" > prime_directive/VERSION
	@$(ENV_PREFIX)gitchangelog > HISTORY.md
	@git add prime_directive/VERSION HISTORY.md
...
switch-to-poetry: ## Switch to poetry package manager.
	...
	@echo "prime_directive = 'prime_directive.__main__:main'" >> pyproject.toml
	...
	@echo "Please run 'poetry shell' or 'poetry run prime_directive'"
